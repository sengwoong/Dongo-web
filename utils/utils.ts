...
export function getScrupedPercent(ctx: CanvasRenderingContext2D, width: number, height: number): number {
...
export function drawImageCenter(canvas: HTMLCanvasElement, ctx: CanvasRenderingContext2D, image: HTMLImageElement): void {
